...
<head>
    ...
    <link href="manifest/vector-map/jqvmap.min.css" rel="stylesheet" media="all">
...
<body>
    ...
    <script src="manifest/vector-map/jquery.vmap.js"></script>
    <script src="manifest/vector-map/jquery.vmap.min.js"></script>
    <script src="manifest/vector-map/jquery.vmap.sampledata.js"></script>
    <script src="manifest/vector-map/jquery.vmap.world.js"></script>
