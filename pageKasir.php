...
<head>
    ...
    <link href="manifest1/vector-map/jqvmap.min.css" rel="stylesheet" media="all">
...
<body>
			...
			<?php 
				...
				switch($page){
					case 'profile':
						...
						break;
                    case 'kasirTransaksi':
                        include "kasir/kasirTransaksi.php";
                        break;
                    case 'kasirPembayaran':
                        include "kasir/kasirPembayaran.php";
                        break;
                    case 'struk':
                        include "kasir/strukTransaksi.php";
                        break;
					default:
						$page = "dashboard";
						include "kasir/dashboard.php";
						break;
				}
    ...
    <script src="manifest1/vector-map/jquery.vmap.js"></script>
    <script src="manifest1/vector-map/jquery.vmap.min.js"></script>
    <script src="manifest1/vector-map/jquery.vmap.sampledata.js"></script>
    <script src="manifest1/vector-map/jquery.vmap.world.js"></script>
