            ...
            if ($jumlah < 1) {
                ...
                if ($sisa['stok_barang'] < $jumlah) {
                    ...
                    if ($num > 0) {
                        ...
                        header("location:pagepunya.php?page=kasirTransaksi");
                    }else{
            ...
            <div class="modal-body">
                <table class="table table-hover table-bordered" id="sampleTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="pagepunya.php?page=kasirTransaksi&getItem&id=<?php echo $brs['kd_barang'] ?>"><?php echo $brs['kd_barang'] ?></a></td>
